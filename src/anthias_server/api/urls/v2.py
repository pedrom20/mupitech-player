...
# MupiTech addition (not upstream Anthias) — kept as a separate import
...
from anthias_server.api.views.mupitech_screenshot import ScreenshotViewV2
...
def get_url_patterns() -> list[URLPattern | URLResolver]:
    return [
        ...
        # api/views/mupitech_ir.py, api/views/mupitech_update.py and
        # api/views/mupitech_screenshot.py.
        ...
        path('v2/screenshot', ScreenshotViewV2.as_view(), name='screenshot_v2'),
